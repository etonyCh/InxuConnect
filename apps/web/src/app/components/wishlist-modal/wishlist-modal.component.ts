...
@Component({
  ...
  styles: [`
    ...
    .modal-card { background: #FFFFFF; width: 100%; max-width: 580px; max-height: 90vh; border-radius: 24px; overflow: hidden; box-shadow: 0 24px 60px rgba(54, 37, 92, 0.3); display: flex; flex-direction: column; }
    ...
    .new-collection-row { display: flex; gap: 0.5rem; flex-wrap: wrap; }
    .form-input { flex: 1; padding: 0.5rem 0.85rem; border-radius: 12px; border: 1px solid #D2C3F6; outline: none; width: 100%; }

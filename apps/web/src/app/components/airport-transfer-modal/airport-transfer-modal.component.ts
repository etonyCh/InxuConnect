...
@Component({
  ...
  styles: [`
    ...
    .modal-card { background: #FFFFFF; width: 100%; max-width: 560px; border-radius: 24px; overflow: hidden; box-shadow: 0 24px 60px rgba(54, 37, 92, 0.3); }
    ...
    .form-input { padding: 0.65rem 0.85rem; border-radius: 12px; border: 1px solid #D2C3F6; font-size: 0.88rem; outline: none; }

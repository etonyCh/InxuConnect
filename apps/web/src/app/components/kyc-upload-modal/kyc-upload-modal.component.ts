...
@Component({
  ...
  styles: [`
    ...
    .modal-card { background: #FFFFFF; width: 100%; max-width: 540px; max-height: 90vh; border-radius: 24px; overflow: hidden; box-shadow: 0 24px 60px rgba(54, 37, 92, 0.3); display: flex; flex-direction: column; }

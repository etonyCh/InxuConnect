...
@Component({
  ...
  styles: [`
    .voice-assistant-card {
      background: linear-gradient(135deg, #3A203B 0%, #522E54 60%, #DCEBD8 100%);
      color: #FFFFFF;
      border-radius: 24px;
      ...
      align-items: center;
      gap: 1rem;
      box-shadow: 0 16px 40px rgba(58, 32, 59, 0.35);
    ...
    .ai-badge {
      ...
      font-size: 0.82rem;
      font-weight: 800;
      background: rgba(220, 235, 216, 0.25);
      color: #DCEBD8;

...
@Component({
  ...
  styles: [`
    ...
    .modal-card {
      background: #FFFFFF; width: 100%; max-width: 600px; border-radius: 24px; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 24px 60px rgba(54, 37, 92, 0.3);
    }
    .modal-header {
      display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.5rem; border-bottom: 1px solid #F3F4F6;
    }
    ...
    .form-input { padding: 0.65rem 0.85rem; border-radius: 12px; border: 1px solid #D2C3F6; font-size: 0.9rem; outline: none; }
    .price-hint-card { background: #F7F4FD; border: 1px solid #D2C3F6; padding: 0.85rem; border-radius: 14px; font-size: 0.82rem; color: #36255C; font-weight: 600; display: flex; align-items: center; gap: 0.5rem; }
    .modal-footer { padding: 1rem 1.5rem; border-top: 1px solid #F3F4F6; display: flex; justify-content: space-between; gap: 1rem; }

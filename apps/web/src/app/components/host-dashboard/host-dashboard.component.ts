...
@Component({
  ...
  styles: [`
    ...
    .modal-card { background: #FFFFFF; width: 100%; max-width: 680px; border-radius: 24px; overflow: hidden; box-shadow: 0 24px 60px rgba(54, 37, 92, 0.3); }
    ...
    .booking-row { display: flex; align-items: center; justify-content: space-between; background: #F9FAFB; padding: 0.85rem; border-radius: 14px; border: 1px solid #E5E7EB; }
